...
;
DROP TABLE IF EXISTS auction_member CASCADE
;
...
(
    ...
    auction_id BIGINT  NOT NULL,
    status     TINYINT NULL,
    CONSTRAINT PK_auction_member PRIMARY KEY (client_id, auction_id)
)
;
...
ALTER TABLE auction_member
    ADD CONSTRAINT FK_auction_member_auction
        FOREIGN KEY (auction_id) REFERENCES auction (auction_id) ON DELETE Restrict ON UPDATE Restrict
;

ALTER TABLE auction_member
    ADD CONSTRAINT FK_auction_member_client
        FOREIGN KEY (client_id) REFERENCES client (user_id) ON DELETE Restrict ON UPDATE Restrict
;
