...
public static final String AUCTION_ENDPOINT = CONTROLLER_URL + "/auction/info";
public static final String ASSIGNMENT_ENDPOINT = CONTROLLER_URL + "/auction/assign";
public static final String LOCALIZATION_PARAM = "lang";
